class Api::V1::FavoritesController < ApplicationController
    ...
    def create
        @favoritable = current_user.favorites.create(favoritable_type: params[:favoritable_type ], favoritable_id: params[:favoritable_id])
        head :ok
    end

    def destroy
        @favoritable = current_user.favorites.find_by(favoritable_type: params[:favoritable_type ], favoritable_id: params[:favoritable_id])
        @favoritable.destroy
        head :ok
    end
end
